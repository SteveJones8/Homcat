...
import com.hjh.connector.RequestStream;
import com.hjh.util.Enumerator;
import com.hjh.util.ParameterMap;
...
public class HttpRequest implements HttpServletRequest {
	...
	protected void parseParameters() {
		...
		if ("POST".equals(getMethod())
			...
			try {
				...
				RequestUtil.parseParameters(results, buf,
						encoding);
	 ...
	 * RequestStream associated with this request, but this can be
	...
	/**
	 * Set a flag indicating whether or not the requested session ID for
	 * this request came in through a cookie. This is normally called by the
